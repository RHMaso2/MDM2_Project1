...
polling_data = pd.read_csv('poll_data_wo_tact_vote.csv')
constituency_data = pd.read_csv('constituency_data_1.csv')
...
log_reg = LogisticRegression(
    ...
    class_weight={0: 0.7, 1: 2.5, 2: 0.35, 3: 3, 4: 0.75, 5: 3}
)
