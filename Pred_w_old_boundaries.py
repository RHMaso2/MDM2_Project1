...
polling_data = pd.read_csv('poll_data_old_bounds.csv')
constituency_data = pd.read_csv('constituency_data_old_bounds.csv')
...
log_reg = LogisticRegression(
    ...
    class_weight={0: 0.8, 1: 1.6, 2: 1.25, 3: 2.75, 4: 2, 5: 1.25}
)
